 ...
 */
class ESCEligibilitySpec extends UnitSpec{

  "Return a valid request for ESC eligibility" in {
    ...
    val escPayload = ESCPayload(eligibility = ESCEligibility(List(taxYear)))
    ...
    val result =Json.toJson[ESCPayload](escPayload)
